...
class CopyController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    return view('copy.index', ['data'=>$data, 'input'=>$input,]);
  }
  ...
  public function confirm(Request $request)
  {
    ...
    return view('copy.confirm', ['data'=>$data, 'input'=>$input,]);
  }
  ...
  public function send(Request $request)
  {
    ...
    if($action == 'back'){
      return redirect(route('copy.index', ['login_id' =>$input['input']['login_id']]))->withInput($input);
