...
<div class="content">
  @foreach($data['warranty'] as $warranty)
    <div class="form form-width-lg">
      <div class="nav">
        <div class="nav-title">保証書詳細({{$warranty->id}})
          <a class="listButton-button button-color-gr" href="{{route('edit.index', ['login_id' =>$data['login_id']])}}?id={{$warranty->id}}">
            <i class="fas fa-edit"></i>&nbsp;編集
          </a>
          <a class="listButton-button button-color-rd" href="{{route('delete.index', ['login_id' =>$data['login_id']])}}?id={{$warranty->id}}">
