...
@section('body')
<div class="content">
  <form method="POST" action="{{route('create.confirm', ['login_id' =>$data['login_id']])}}" class="h-adr">
    @csrf
    <div class="form form-width-lg">
      ...
      <div class="form-box box-size-lg box-color-bl">
        ...
        <div class="form-row form-size-md">
          ...
          <div class="formRow-value">
            <input name="kana" type="text" class="form-control form-control-sm @if($errors->has('kana'))form-error @endif" value=@if(Session::get('kana'))"{{Session::get('kana')}}"@else"{{old('kana')}}"@endif />
        ...
        <div class="form-row form-size-tel">
          ...
          <div class="formRow-value">
            ...
            <input name="tel_fix" type="text" class="form-control form-control-sm form-size-sm @if($errors->has('tel_fix'))form-error @endif" value=@if(Session::get('tel_fix'))"{{Session::get('tel_fix')}}"@else"{{old('tel_fix')}}"@endif />
            <div class="form-caption caption-right">携帯電話</div>
            <input name="tel_mobile" type="text" class="form-control form-control-sm form-size-sm @if($errors->has('tel_mobile'))form-error @endif" value=@if(Session::get('tel_mobile'))"{{Session::get('tel_mobile')}}"@else"{{old('tel_mobile')}}"@endif />
        ...
        <div class="form-row form-size-max">
          ...
          <div class="formRow-value">
              ...
              <input name="address" type="text" class="p-region p-locality p-street-address form-control form-control-sm form-size-lg @if($errors->has('address'))form-error @endif" value=@if(Session::get('address'))"{{Session::get('address')}}"@else"{{old('address')}}"@endif />
